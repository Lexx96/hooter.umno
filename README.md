...
распространения персональных данных, обрабатываемых в мобильном приложении «Гудок.UMNO».
...
предоставляя свои персональные данные в мобильном приложении «Гудок.UMNO»
(далее – Приложение), выражаете свободно, своей волей и в своем интересе
...
3. Персональные данные – это любая информация, относящаяся к прямо или косвенно
...
4. Обработка персональных данных Пользователя Приложения осуществляется в
следующих целях:
3.1.1. Регистрации и идентификации Пользователя Приложения;
...
5. Использование Приложения и предоставление АО «НефтеТрансСервис» своих
...
обработки персональных данных, размещаемых в мобильном приложении «Гудок.UMNO»,
с учетом действующего законодательства РФ, с соблюдением мер,
обеспечивающих защиту персональных данных от несанкционированного доступа.

6. Пользователь Приложения соглашается с тем, что в целях обеспечения выполнения
...
7. Настоящим Пользователь Приложения подтверждает ознакомление и согласие с
...
8. Настоящее Согласие действует до дня получения Оператором отзыва в письменной
